...
function usePresence() {
  ...
  (0, import_react.useEffect)(() => register(id4), []);
  const safeToRemove = (0, import_react.useCallback)(() => onExitComplete && onExitComplete(id4), [id4, onExitComplete]);
...
var createDomVisualElement = (Component3, options) => {
  return isSVGComponent(Component3) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== import_react3.Fragment
  });
};
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  return (0, import_jsx_runtime2.jsx)(PopChildMeasure, { isPresent: isPresent2, childRef: ref, sizeRef: size, children: React.cloneElement(children, { ref }) });
}
...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode }) => {
  ...
  if (mode === "popLayout") {
    children = (0, import_jsx_runtime3.jsx)(PopChild, { isPresent: isPresent2, children });
  }
...
var AnimatePresence = ({ children, exitBeforeEnter, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const presentChildren = (0, import_react7.useMemo)(() => onlyElements(children), [children]);
  const presentKeys = presentChildren.map(getChildKey);
  const isInitialRender = (0, import_react7.useRef)(true);
  const pendingPresentChildren = (0, import_react7.useRef)(presentChildren);
  const exitComplete = useConstant(() => /* @__PURE__ */ new Map());
  const [diffedChildren, setDiffedChildren] = (0, import_react7.useState)(presentChildren);
  const [renderedChildren, setRenderedChildren] = (0, import_react7.useState)(presentChildren);
  useIsomorphicLayoutEffect(() => {
  ...
  const { forceRender } = (0, import_react7.useContext)(LayoutGroupContext);
  return (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime4.jsx)(PresenceChild, { isPresent: isPresent2, initial: !isInitialRender.current || initial ? void 0 : false, custom: isPresent2 ? void 0 : custom, presenceAffectsLayout, mode, onExitComplete: isPresent2 ? void 0 : onExit, children: child }, key);
  }) });
};
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react8.useContext)(MotionConfigContext), ...config };
  config.isStatic = useConstant(() => config.isStatic);
  const context = (0, import_react8.useMemo)(() => config, [
    JSON.stringify(config.transition),
    config.transformPagePoint,
    config.reducedMotion
  ]);
  return (0, import_jsx_runtime5.jsx)(MotionConfigContext.Provider, { value: context, children });
}
...
function LazyMotion({ children, features, strict = false }) {
  ...
  return (0, import_jsx_runtime6.jsx)(LazyContext.Provider, { value: { renderer: loadedRenderer.current, strict }, children });
}
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
  ...
  return (0, import_jsx_runtime7.jsx)(LayoutGroupContext.Provider, { value: memoizedContext, children });
};
...
function useSpring(source, config = {}) {
  ...
  const latestValue = (0, import_react15.useRef)(value.get());
  const latestSetter = (0, import_react15.useRef)(() => {
  });
...
function useMotionValueEvent(value, event, callback) {
  (0, import_react16.useInsertionEffect)(() => value.on(event, callback), [value, event, callback]);
}
...
function useScroll({ container, target, layoutEffect = true, ...options } = {}) {
  ...
  const useLifecycleEffect = layoutEffect ? useIsomorphicLayoutEffect : import_react17.useEffect;
  useLifecycleEffect(() => {
...
function useAnimationFrame(callback) {
  const initialTimestamp = (0, import_react18.useRef)(0);
...
function useReducedMotion() {
  ...
  const [shouldReduceMotion] = (0, import_react19.useState)(prefersReducedMotion.current);
  if (true) {
...
function useReducedMotionConfig() {
  ...
  const { reducedMotion } = (0, import_react20.useContext)(MotionConfigContext);
...
function useInView(ref, { root, margin, amount, once = false } = {}) {
  const [isInView, setInView] = (0, import_react23.useState)(false);
...
function useInstantTransition() {
  ...
  const unlockOnFrameRef = (0, import_react25.useRef)();
